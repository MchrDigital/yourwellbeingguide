...
var campaignIds = {
    'default': "6928c940f3edfecc8027ac27",
}
var cookieDomain = ""
...
var initialSrc = "https://tracking.todaywellness2report.com/" + campaignID + "?format=json" + "&referrer=" + referrer;
for (var i = 1; i <= 10; i++) {
...
function setHref(clickID, ref) {
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("https://tracking.todaywellness2report.com/click") > -1) {
...
function xhrrOpenAndSend(clickID, ref) {
    ...
    if (getSessionRegisterViewOncePerSession() !== 1) {
        xhrr.open("GET", "https://tracking.todaywellness2report.com/view?clickid=" + clickID + "&referrer=" + ref)
        xhrr.send();
    }
...
(function () {
    ...
    const interval = setInterval(() => {
        ...
        if ((fbp || fbc) && clickId) {
            ...
            const url = new URL('https://tracking.todaywellness2report.com/clickupd/' + clickId)
